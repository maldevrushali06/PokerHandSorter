...
import java.io.*;
/**
* <h1>PokerHandPlayer</h1>
* The PokerHandPlayer program implements an application that
* takes input from text file (poker-hands.txt), analyse the input
*, applies poker card game rule algorithm for 2 players to find the winner
...
public class PokerHandPlayer {
	public static void main(String[] args) throws IOException{
		...
		*/
		...
		//BufferedReader br = new BufferedReader(new FileReader(new File("./poker-hands.txt").getCanonicalPath()));
		BufferedReader br = new BufferedReader(new InputStreamReader(System.in));
        String twoHands;
        int player1WinCount = 0,player2WinCount = 0,tieCount=0;
		while ((twoHands = br.readLine()) != null){
			...
			String result = Hand.getWinner(blackHand, whiteHand);
...
class Hand {
	...
	private static int compareRecursiveHighCard(Hand hand1, Hand hand2) {
		Card[] hand1Cards = hand1.getHand();
		Card[] hand2Cards = hand2.getHand();
	...
	private static Card compareFourOfAKind(Hand tempHand) {
	...
	// 12345
	// 123 234 345
	private static Card compareThreeOfAKind(Hand tempHand) {
		Card[] tempCards = tempHand.getHand();
